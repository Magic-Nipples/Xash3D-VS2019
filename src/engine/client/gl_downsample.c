...
{
	if (r_downsample_size->value < 0.1f)
		r_downsample_size->value = 0.1f;

	if (r_downsample_size->value > 1.0f)
		r_downsample_size->value = 1.0f;

	DOWNSAMPLE_SIZE_X = screen_texture_width * r_downsample_size->value;
	DOWNSAMPLE_SIZE_Y = screen_texture_width * r_downsample_size->value;
