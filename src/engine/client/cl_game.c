...
=========
*/
HSPRITE_HL pfnSPR_LoadExt( const char *szPicName, uint texFlags )
{
	model_t	*spr;
...
=============
*/
const model_t *CL_GetSpritePointer( HSPRITE_HL hSprite )
{
	model_t	*mod;
...
=========
*/
static int pfnSPR_Frames( HSPRITE_HL hPic )
{
	int	numFrames;
...
=========
*/
static int pfnSPR_Height( HSPRITE_HL hPic, int frame )
{
	int	sprHeight;
...
=========
*/
static int pfnSPR_Width( HSPRITE_HL hPic, int frame )
{
	int	sprWidth;
...
=========
*/
static void pfnSPR_Set( HSPRITE_HL hPic, int r, int g, int b )
{
...
=============
*/
static void pfnSetCrosshair( HSPRITE_HL hspr, wrect_t rc, int r, int g, int b )
{
