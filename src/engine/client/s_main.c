...
qboolean S_Init( void )
{
	...
	s_mixahead = Cvar_Get( "_snd_mixahead", "0.08", 0, "how much sound to mix ahead of time" ); //magic nipples - was 0.12 but lowering the value to 0.08 has near instant sound.
